...
// Function to generate all suboptimal structures for sequence in structure ct and store them in
// structure ct.
...
// absolutedelta is the maximum folding free energy change (in kcal/mol * conversionfactor, as
...
void alltrace(structure* ct, datatable* data, short percentdelta, short absolutedelta,
    TProgressDialog* update, char* save, bool NoMBLoop = false);
...
void realltrace(char* savefilename, structure* ct, short percentdelta, short absolutedelta,
    char* ctname = NULL);

#define startingsize \
  500  // maximum number of structure fragments to start in alltracestructurestack (below)
...
public:
  ...
  void push();
  void push(integersize totalenergy, bool topair, short pairi, short pairj, bool tostack, short i,
      short j, short open, integersize energy, short pair, bool topair2, short pairi2, short pairj2,
      bool tostack2, short i2, short j2, short open2, integersize energy2, short pair2,
      bool tostack3 = false, short i3 = 0, short j3 = 0, short open3 = 0, integersize energy3 = 0,
      short pair3 = 0);
