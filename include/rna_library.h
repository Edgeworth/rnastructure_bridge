...
// data files
{
  short int poppen[5], maxpen, eparam[11], dangle[6][6][6][3], inter[31], bulge[31], hairpin[31],
      stack[6][6][6][6], tstkh[6][6][6][6], tstki[6][6][6][6], tloop[maxtloop + 1][2], numoftloops,
      ...
      triloop[maxtloop + 1][2], numoftriloops, init, mlasym, strain, numofhexaloops, singlecbulge,
      tstki23[6][6][6][6], tstki1n[6][6][6][6];
...
// calculates the energy of an exterior part of an internal loop (only has length and terminal stack
// components)
...
// When adding the included and excluded fragments for a structure with pair i-j, the SHAPE free
// energy needs correction
