...
public:
  PFPRECISION poppen[5], maxpen, eparam[11], dangle[6][6][6][3], inter[31], bulge[31], hairpin[31],
      stack[6][6][6][6], tstkh[6][6][6][6], tstki[6][6][6][6], tloop[maxtloop + 1],
      iloop22[6][6][6][6][6][6][6][6], iloop21[6][6][6][6][6][6][6], iloop11[6][6][6][6][6][6],
      coax[6][6][6][6], tstackcoax[6][6][6][6], coaxstack[6][6][6][6], tstack[6][6][6][6],
      tstkm[6][6][6][6], auend, gubonus, cint, cslope, c3, efn2a, efn2b, efn2c,
      triloop[maxtloop + 1], init, mlasym, strain, singlecbulge, tstki23[6][6][6][6],
      tstki1n[6][6][6][6];
...
PFPRECISION erg2in(
    int i, int j, int ip, int jp, structure* ct, pfdatatable* data, char a = 0, char b = 0);
...
void pfunction(structure* ct, pfdatatable* data, TProgressDialog* update, char* save,
    bool quickQ = false, PFPRECISION* Q = NULL);
...
void rescale(int currenth, structure* ct, pfdatatable* data, DynProgArray<PFPRECISION>* v,
    ...
    PFPRECISION rescalefactor);  // function to rescale all arrays when partition function
                                 // calculation is headed out
// of bounds
// void rescaleatw3(int ii,structure *ct, pfdatatable *data, DynProgArray<PFPRECISION> *v,
// DynProgArray<PFPRECISION> *w, DynProgArray<PFPRECISION> *wl, DynProgArray<PFPRECISION> *wcoax,
//			 DynProgArray<PFPRECISION> *wmb,DynProgArray<PFPRECISION> *wmbl, PFPRECISION *w5,
//PFPRECISION *w3, double rescalefactor); //function to rescale all arrays when partition function
//calculation is headed out
...
void thresh_structure(structure* ct, char* pfsfile, double thresh);  // determine a structure of
                                                                     // probable base pairs (greater
                                                                     // than thresh) and deposit it
                                                                     // in ct.
