...
void fill(structure *ct, DynProgArray<integersize> &v, DynProgArray<integersize> &w, DynProgArray<integersize> &wmb, forceclass &fce, int &vmin,bool *lfce, bool *mod,
          ...
          datatable *data, DynProgArray<integersize> *w2, DynProgArray<integersize> *wmb2, DynProgArray<integersize> *we,ProgressHandler* update = 0, int maxinter = 30, bool quickstructure = false, bool simple_iloops = true, bool disablecoax=false);
...
void dynamic (structure *ct,datatable* data,int cntrl6, int cntrl8,int cntrl9,
              ...
              ProgressHandler* update=0, bool quickenergy = false, char* savefile = 0, int maxinter = 30, bool quickstructure = false, bool simple_iloops = true, bool disablecoax=false);
