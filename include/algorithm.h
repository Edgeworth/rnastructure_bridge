...
fill(structure* ct, arrayclass& v, arrayclass& w, arrayclass& wmb, forceclass& fce, int& vmin, bool* lfce, bool* mod,
    ...
    datatable* data, arrayclass* w2, arrayclass* wmb2, arrayclass* we, TProgressDialog* update = 0, int maxinter = 30,
...
void
fill(structure* ct, arrayclass& v, arrayclass& vmb, arrayclass& vext, arrayclass& w, arrayclass& wmb, forceclass& fce,
